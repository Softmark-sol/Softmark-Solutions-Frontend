    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        <div
          ...
          style={{ textAlign: "center", marginBottom: "20px", width: "20%" }}
        >
          <img
            src={Logo}
          ...
          >
            ...
            <a
              href="https://www.facebook.com/SoftMarkSolutionsLLC"
              aria-label="Facebook"
            >
              <FaFacebookF />
            </a>
            ...
            <a
              href="https://www.instagram.com/softmark_sol/"
        ...
        <div className="footer-right" style={{ cursor: "default" }}>
          <div className="footer-contact">
            ...
            <p>
              <i className="fa fa-home" aria-hidden="true"></i> 30 N Gould St R,
              Sheridan, WY 82801
            </p>
            <p>
              <a
            ...
            <p>
              <a
                href="tel:+16465356323"
                style={{ color: "inherit", textDecoration: "none" }}
              >
                <i className="fa fa-phone" aria-hidden="true"></i> +1 (646)
                535-6323
              </a>
            </p>
          </div>
      ...
      <div style={{ textAlign: "center", paddingTop: "50px" }}>
        © 2024 Copyright: Softmark Solutions.
      </div>
    </footer>
  );
};
