          ...
          <div key={index}>
            <Card
              style={{
                ...
                boxShadow: hovered === index ? '0 8px 20px rgba(0, 0, 0, 0.2)' : '0 4px 12px rgba(0, 0, 0, 0.1)',
                borderRadius: 8,
                ...
                maxWidth: '270px',
                margin: '0 auto',
                transform: hovered === index ? 'translateY(-8px)' : 'translateY(0)', // Hover lift effect
                cursor: 'pointer',
              }}
              onMouseEnter={() => setHovered(index)} // Set hover state when entering
              onMouseLeave={() => setHovered(null)} // Reset hover state when leaving
            >
              <CardContent>
                <div>
                  <img style={{
