  ...
  return (
    <div className="seo container">
      ...
      <div className="horizontal-fram-seo">
        <div style={{ width: "100%" }}>
          <p className="seo-p">
            When it comes to SEO, two things can make a mark difference:
            Experience and Knowledge. At Softmark Solutions, with our decades of
            experience, technical knowledge, and hard work, we aim to deliver
            100% proven results. Our SEO experts are highly skilled, creative,
            and passionate about helping businesses like YOURs to succeed. From
            consultancy to content marketing, we’re providing a range of SEO
            services that are specifically designed to fit your business needs.
          </p>
        </div>
      ...
      <button className="button-primary" onClick={()=>naviagte('/contactUs')}>Request a Proposal Today!</button>

      <h1 className="seo-subheader">Our SEO Services</h1>
      ...
      <div className="horizontal-fram-seo">
        ...
        <div style={{ width: "100%" }}>
          ...
          <p className="seo-p">
            With our SEO consultancy services, we’ll guide you through the
            complexities of SEO. If you’re unsure of where to start, there is no
            need to worry about it because we’ll assess your current SEO
            strategy and pinpoint areas for improvement. Our consultants will
            closely work with you to make sure that your SEO strategies are
            completely aligned with your business goals. You’ll receive clear
            and practical advice to boost your website.
          </p>
        </div>
      </div>
      ...
      <div className="horizontal-fram-seo">
        <div style={{ width: "100%" }}>
          ...
          <p className="seo-p">
            A well-functioning website is essential for SEO success. Our
            technical SEO audit will identify issues that may be holding back
            your site. We analyze everything, such as site speed, mobile
            optimization, and crawlability. After the audit, we’ll provide
            actionable recommendations that can help improve your site’s
            performance. Our goal is to make sure that your website is both
      ...
      <div className="horizontal-fram-seo">
        ...
        <div style={{ width: "100%" }}>
          ...
          <p className="seo-p">
            Our keyword and market research services provide in-depth insights
            into what your target audience is looking for. We'll assist you in
            identifying the most relevant keywords for your business and target
            market. This data enables us to create strategies that target the
            right audience and improve your chances of ranking on the first page.
          </p>
        </div>
      </div>
      ...
      <div className="horizontal-fram-seo">
        <div style={{ width: "100%" }}>
          ...
          <p className="seo-p">
            With our onsite SEO services, we’ll make your website as search
            engine-friendly as possible. We’ll optimize your content, meta tags,
            headers, linking, and other key elements. Our experts will also
            improve your site’s structure to make it easier for visitors to
            navigate. After that, we guarantee you’ll see better rankings and
            engagements from visitors.
          </p>
        </div>
        <div className="seo-animation">
          <img
      ...
      <h1>Are you ready to take your SEO to the next level? 
      </h1>
      ...
      <button className="button-secondary" onClick={()=>naviagte('/contactUs')}>Request a Proposal Today!</button>
